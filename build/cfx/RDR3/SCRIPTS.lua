...
--@module NATIVE
--@submodule SCRIPTS
--@see _0x31010318BA9897AC
--@usage undefined _0x31010318BA9897AC(Any p0,Any p1);
--@params p0 Any
--@params p1 Any
--@return undefined
...
--@module NATIVE
--@submodule SCRIPTS
--@see _0xD426E2E3288469D6
--@usage undefined _0xD426E2E3288469D6(Any p0,Any p1);
--@params p0 Any
--@params p1 Any
--@return undefined
...
--@module NATIVE
--@submodule SCRIPTS
--@see _0xFFDDF802279BE128
--@usage undefined _0xFFDDF802279BE128(Any p0,Any p1,Any p2);
--@params p0 Any
--@params p1 Any
--@params p2 Any
--@return undefined
...
--@module NATIVE
--@submodule SCRIPTS
--@see _0x72B2E00C9BAC6789
--@usage undefined _0x72B2E00C9BAC6789(Any p0,Any p1);
--@params p0 Any
--@params p1 Any
--@return undefined
...
--@module NATIVE
--@submodule SCRIPTS
--@see SET_BLOCK_OF_PLAYER_BITS
--@usage undefined SET_BLOCK_OF_PLAYER_BITS(Any p0,Any p1,Any p2);
--@params p0 Any
--@params p1 Any
--@params p2 Any
--@return undefined
...
--@module NATIVE
--@submodule SCRIPTS
--@see _0x1C5EB3C27F7508CB
--@usage undefined _0x1C5EB3C27F7508CB(Any p0,Any p1);
--@params p0 Any
--@params p1 Any
--@return undefined
...
--@module NATIVE
--@submodule SCRIPTS
--@see _0x42A429CDFED6D99D
--@usage undefined _0x42A429CDFED6D99D(Any p0,Any p1,Any p2);
--@params p0 Any
--@params p1 Any
--@params p2 Any
--@return undefined
...
--@module NATIVE
--@submodule SCRIPTS
--@see _0x0A79C81C418F5D38
--@usage undefined _0x0A79C81C418F5D38(Any p0,Any p1);
--@params p0 Any
--@params p1 Any
--@return undefined
...
--@usage undefined IS_THREAD_ACTIVE(int threadId,BOOL p1);
--@params threadId int
--@params p1 BOOL
--@return undefined
...
--@module NATIVE
--@submodule SCRIPTS
--@see _0xD92FA81B64920E85
--@usage undefined _0xD92FA81B64920E85(Any p0,Any p1,Any p2);
--@params p0 Any
--@params p1 Any
--@params p2 Any
--@return undefined
...
--@usage undefined GET_EVENT_EXISTS(int eventGroup,int eventIndex);
--@params eventGroup int
...
--@submodule SCRIPTS
--@see GET_EVENT_DATA
--@usage undefined GET_EVENT_DATA(int eventGroup,int eventIndex,int* argStruct,int argStructSize);
--@params eventGroup int
--@params eventIndex int
...
--@usage undefined TRIGGER_SCRIPT_EVENT(int eventGroup,Any* args,int argCount,int bitset,Any* p4);
--@params eventGroup int
--@params args Any*
--@params argCount int
--@params bitset int
--@params p4 Any*
--@return undefined
function TriggerScriptEvent(eventGroup,args,argCount,bitset,p4) end

--@description This natives does not have an official description.
--@module NATIVE
--@submodule SCRIPTS
--@see _0xE7282390542F570D
...
--@module NATIVE
--@submodule SCRIPTS
--@see SET_EVENT_FLAG_FOR_DELETION
--@usage undefined SET_EVENT_FLAG_FOR_DELETION(Any p0,Any p1,Any p2);
--@params p0 Any
--@params p1 Any
--@params p2 Any
--@return undefined
...
--@usage undefined _TRIGGER_SCRIPT_EVENT_2(Any* args,int argCount,int bitset,int threadId);
--@params args Any*
--@params argCount int
--@params bitset int
--@params threadId int
--@return undefined
function TriggerScriptEvent_2(args,argCount,bitset,threadId) end

--@description This natives does not have an official description.
--@module NATIVE
--@submodule SCRIPTS
--@see _0xF9E951A1E5517C06
...
--@module NATIVE
--@submodule SCRIPTS
--@see _SHOW_LOADING_SCREEN
--@usage undefined _SHOW_LOADING_SCREEN(Hash p0,Hash p1,Hash p2,const char* gamemodeName,const char* title,const char* subtitle);
--@params p0 Hash
--@params p1 Hash
--@params p2 Hash
--@params gamemodeName const char*
...
--@module NATIVE
--@submodule SCRIPTS
--@see _0x29FB4CE89472C3CB
--@usage undefined _0x29FB4CE89472C3CB(Any p0,Any p1,Any p2,Any p3,Any p4,Any p5,Any p6,Any p7);
--@params p0 Any
--@params p1 Any
--@params p2 Any
--@params p3 Any
...
--@module NATIVE
--@submodule SCRIPTS
--@see _0x4AE1DFF337A86FDE
--@usage undefined _0x4AE1DFF337A86FDE(int scriptIndex,const char* p1);
...
--@module NATIVE
--@submodule SCRIPTS
--@see _0x55C40B7592BAD213
--@usage undefined _0x55C40B7592BAD213(int scriptIndex,const char* p1);
--@params scriptIndex int
--@params p1 const char*
--@return undefined
...
--@module NATIVE
--@submodule SCRIPTS
--@see _0xB9467E41DAB1CF2C
--@usage undefined _0xB9467E41DAB1CF2C(Any p0,Any p1,Any p2,Any p3);
--@params p0 Any
--@params p1 Any
--@params p2 Any
--@params p3 Any
...
--@module NATIVE
--@submodule SCRIPTS
--@see _STORE_GLOBAL_BLOCK
--@usage undefined _STORE_GLOBAL_BLOCK(int index);
--@params index int
--@return undefined
...
--@module NATIVE
--@submodule SCRIPTS
--@see _RESTORE_GLOBAL_BLOCK
--@usage undefined _RESTORE_GLOBAL_BLOCK(int index);
--@params index int
--@return undefined
...
--@module NATIVE
--@submodule SCRIPTS
--@see _DOES_COMPRESSED_GLOBAL_BLOCK_BUFFER_EXIST
--@usage undefined _DOES_COMPRESSED_GLOBAL_BLOCK_BUFFER_EXIST(int index);
--@params index int
--@return undefined
...
--@module NATIVE
--@submodule SCRIPTS
--@see _SET_GLOBAL_BLOCK_CAN_BE_ACCESSED
--@usage undefined _SET_GLOBAL_BLOCK_CAN_BE_ACCESSED(int index,BOOL toggle);
--@params index int
--@params toggle BOOL
--@return undefined
...
--@module NATIVE
--@submodule SCRIPTS
--@see _GET_GLOBAL_BLOCK_CAN_BE_ACCESSED
...
--@usage undefined START_NEW_SCRIPT_WITH_ARGS(const char* scriptName,Any* args,int argCount,int stackSize);
--@params scriptName const char*
--@params args Any*
--@params argCount int
--@params stackSize int
...
--@usage undefined START_NEW_SCRIPT_WITH_NAME_HASH_AND_ARGS(Hash scriptHash,Any* args,int argCount,int stackSize);
--@params scriptHash Hash
--@params args Any*
--@params argCount int
--@params stackSize int
...
--@usage undefined START_NEW_SCRIPT_WITH_NAME_HASH(Hash scriptHash,int stackSize);
--@params scriptHash Hash
--@params stackSize int
--@return undefined
