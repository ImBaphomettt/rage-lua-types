...
--@see _LOCALIZATION_GET_SYSTEM_LANGUAGE
...
--@module NATIVE
--@submodule LOCALIZATION
--@see _LOCALIZATION_GET_SYSTEM_DATE_FORMAT
--@usage undefined _LOCALIZATION_GET_SYSTEM_DATE_FORMAT();
