...
--@usage undefined DESTROY_ALL_CAMS(BOOL p0);
--@params p0 BOOL
--@return undefined
...
--@submodule CAM
--@see DESTROY_CAM
--@usage undefined DESTROY_CAM(Cam cam,BOOL p1);
--@params cam Cam
--@params p1 BOOL
--@return undefined
...
--@module NATIVE
--@submodule CAM
--@see _DISABLE_FIRST_PERSON_CAM_THIS_FRAME_2
--@usage undefined _DISABLE_FIRST_PERSON_CAM_THIS_FRAME_2();
...
--@module NATIVE
--@submodule CAM
--@see _FREEZE_GAMEPLAY_CAM_THIS_FRAME
--@usage undefined _FREEZE_GAMEPLAY_CAM_THIS_FRAME();
...
--@module NATIVE
--@submodule CAM
--@see _TRIGGER_MISSION_FAILED_CAM
--@usage undefined _TRIGGER_MISSION_FAILED_CAM();
