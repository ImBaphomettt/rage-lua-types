...
--@usage Any _ADD_DISPATCH_SPAWN_BLOCKING_ANGLED_AREA(float p0,float p1,float p2,float p3,float p4,float p5,float p6);
--@params p0 float
--@params p1 float
--@params p2 float
--@params p3 float
...
--@params p6 float
--@return Any
function AddDispatchSpawnBlockingAngledArea(p0, p1, p2, p3, p4, p5, p6)
end
...
--@usage int ADD_POP_MULTIPLIER_AREA(float x1,float y1,float z1,float x2,float y2,float z2,float p6,float p7,BOOL p8);
--@params x1 float
--@params y1 float
--@params z1 float
--@params x2 float
...
--@usage Any _ADD_DISPATCH_SPAWN_BLOCKING_AREA(float p0,float p1,float p2,float p3);
--@params p0 float
--@params p1 float
--@params p2 float
--@params p3 float
...
--@usage int ADD_POP_MULTIPLIER_SPHERE(float p0,float p1,float p2,float p3,float p4,float p5,BOOL p6,BOOL p7);
--@params p0 float
--@params p1 float
--@params p2 float
--@params p3 float
...
--@params p7 BOOL
--@return int
function AddPopMultiplierSphere(p0, p1, p2, p3, p4, p5, p6, p7)
end
...
--@submodule MISC
--@see ADD_STUNT_JUMP
--@usage int ADD_STUNT_JUMP(float x1,float y1,float z1,float x2,float y2,float z2,float x3,float y3,float z3,float x4,float y4,float z4,float camX,float camY,float camZ,int unk1,int unk2,int unk3);
--@params x1 float
--@params y1 float
--@params z1 float
--@params x2 float
...
--@usage int ADD_STUNT_JUMP_ANGLED(float x1,float y1,float z1,float x2,float y2,float z2,float radius1,float x3,float y3,float z3,float x4,float y4,float z4,float radius2,float camX,float camY,float camZ,int unk1,int unk2,int unk3);
--@params x1 float
--@params y1 float
--@params z1 float
--@params x2 float
...
--@usage BOOL ARE_PROFILE_SETTINGS_VALID();
...
--@params radius float
--@params p4 BOOL
--@params ignoreCopCars BOOL
--@params ignoreObjects BOOL
--@params p7 BOOL
--@return void
...
--@usage void CLEAR_AREA_OF_PROJECTILES(float x,float y,float z,float radius,BOOL flags);
--@params x float
--@params y float
--@params z float
--@params radius float
...
--@module NATIVE
--@submodule MISC
--@see _CLEAR_AREA_OF_EVERYTHING
--@usage void _CLEAR_AREA_OF_EVERYTHING(float x,float y,float z,float radius,BOOL p4,BOOL p5,BOOL p6,BOOL p7);
--@params x float
--@params y float
--@params z float
--@params radius float
...
--@params p7 BOOL
--@return void
function ClearAreaOfEverything(x, y, z, radius, p4, p5, p6, p7)
end
...
--@submodule MISC
--@see CREATE_INCIDENT
--@usage BOOL CREATE_INCIDENT(int dispatchService,float x,float y,float z,int numUnits,float radius,int* outIncidentID);
--@params dispatchService int
--@params x float
--@params y float
--@params z float
...
--@params p0 int
--@params windowTitle char*
--@params p2 char*
--@params defaultText char*
--@params defaultConcat1 char*
--@params defaultConcat2 char*
--@params defaultConcat3 char*
...
--@params defaultConcat2 char*
--@params defaultConcat3 char*
--@params defaultConcat4 char*
--@params defaultConcat5 char*
--@params defaultConcat6 char*
--@params defaultConcat7 char*
--@params maxInputLength int
--@return void
...
--@usage BOOL DOES_POP_MULTIPLIER_SPHERE_EXIST(int id);
--@params id int
--@return BOOL
...
--@usage BOOL CREATE_INCIDENT_WITH_ENTITY(int dispatchService,Ped ped,int numUnits,float radius,int* outIncidentID);
--@params dispatchService int
--@params ped Ped
--@params numUnits int
--@params radius float
...
--@usage BOOL DOES_POP_MULTIPLIER_AREA_EXIST(int id);
--@params id int
--@return BOOL
...
--@module NATIVE
--@submodule MISC
--@see _FORCE_SOCIAL_CLUB_UPDATE
--@usage void _FORCE_SOCIAL_CLUB_UPDATE();
...
--@usage int _GET_BENCHMARK_ITERATIONS_FROM_COMMAND_LINE();
...
--@usage BOOL _GET_BASE_ELEMENT_METADATA(Any* p1,Any* p2,Any p3,BOOL p4);
--@params p1 Any*
--@params p2 Any*
--@params p3 Any
--@params p4 BOOL
...
--@usage float _GET_BENCHMARK_TIME();
...
--@usage int _GET_BENCHMARK_PASS_FROM_COMMAND_LINE();
...
--@usage float _GET_CLOUD_HAT_OPACITY();
...
--@usage char* _GET_GLOBAL_CHAR_BUFFER();
...
--@usage BOOL GET_GROUND_Z_AND_NORMAL_FOR_3D_COORD(float x,float y,float z,float* groundZ,Vector3* normal);
--@params x float
--@params y float
--@params z float
...
--@params unk BOOL
--@return BOOL
function GetGroundZFor_3dCoord(x, y, z, groundZ, unk)
end

--@description This natives does not have an official description.
--@module NATIVE
--@submodule MISC
--@see _GET_GROUND_Z_FOR_3D_COORD_2
--@usage BOOL _GET_GROUND_Z_FOR_3D_COORD_2(float x,float y,float z,float* groundZ,BOOL p4);
--@params x float
--@params y float
--@params z float
--@params groundZ float*
--@params p4 BOOL
--@return BOOL
function GetGroundZFor_3dCoord_2(x, y, z, groundZ, p4)
end
...
--@submodule MISC
--@see GET_HASH_KEY
--@usage Hash GET_HASH_KEY(char* string);
--@params string char*
--@return Hash
...
--@usage BOOL _GET_IS_PLAYER_IN_ANIMAL_FORM();
...
--@module NATIVE
--@submodule MISC
--@see _GET_IS_PROJECTILE_TYPE_IN_AREA
--@usage BOOL _GET_IS_PROJECTILE_TYPE_IN_AREA(float x1,float y1,float z1,float x2,float y2,float z2,Hash projHash,Vector3* projPos,BOOL ownedByPlayer);
--@params x1 float
--@params y1 float
--@params z1 float
--@params x2 float
--@params y2 float
--@params z2 float
--@params projHash Hash
--@params projPos Vector3*
--@params ownedByPlayer BOOL
--@return BOOL
function GetIsProjectileTypeInArea(x1, y1, z1, x2, y2, z2, projHash, projPos, ownedByPlayer)
end
...
--@usage BOOL GET_IS_AUTO_SAVE_OFF();
...
--@usage int GET_NUM_SUCCESSFUL_STUNT_JUMPS();
...
--@module NATIVE
--@submodule MISC
--@see _GET_NUMBER_OF_DISPATCHED_UNITS_FOR_PLAYER
--@usage int _GET_NUMBER_OF_DISPATCHED_UNITS_FOR_PLAYER(int dispatchService);
--@params dispatchService int
--@return int
function GetNumberOfDispatchedUnitsForPlayer(dispatchService)
end
...
--@usage int GET_NUMBER_OF_FREE_STACKS_OF_THIS_SIZE(int stackSize);
...
--@usage BOOL _GET_PROJECTILE_NEAR_PED_COORDS(Ped ped,Hash weaponHash,float radius,Vector3* entity,BOOL ownedByPlayer);
--@params ped Ped
--@params weaponHash Hash
--@params radius float
--@params entity Vector3*
--@params ownedByPlayer BOOL
--@return BOOL
function GetProjectileNearPedCoords(ped, weaponHash, radius, entity, ownedByPlayer)
end
...
--@usage BOOL _GET_PROJECTILE_NEAR_PED(Ped ped,Hash weaponhash,float radius,Vector3* projPos,Entity* projEnt,BOOL ownedByPlayer);
--@params ped Ped
--@params weaponhash Hash
--@params radius float
--@params projPos Vector3*
--@params projEnt Entity*
--@params ownedByPlayer BOOL
--@return BOOL
...
--@usage int _GET_POWER_SAVING_MODE_DURATION();
...
--@usage BOOL GET_TENNIS_SWING_ANIM_COMPLETE(Ped ped);
--@params ped Ped
--@return BOOL
...
--@usage int GET_REPLAY_STAT_MISSION_TYPE();
...
--@usage int GET_REPLAY_STAT_AT_INDEX(int index);
--@params index int
--@return int
...
--@usage int GET_TOTAL_SUCCESSFUL_STUNT_JUMPS();
...
--@usage BOOL _HAS_BUTTON_COMBINATION_JUST_BEEN_ENTERED(Hash hash,int amount);
--@params hash Hash
--@params amount int
--@return BOOL
...
--@usage BOOL _HAS_CHEAT_STRING_JUST_BEEN_ENTERED(Hash hash);
--@params hash Hash
--@return BOOL
...
--@usage BOOL HAVE_CREDITS_REACHED_END();
...
--@usage BOOL _HAS_RESUMED_FROM_SUSPEND();
...
--@usage int GET_REPLAY_STAT_COUNT();
...
--@usage BOOL _IS_COMMAND_LINE_BENCHMARK_VALUE_SET();
...
--@usage BOOL _IS_IN_POWER_SAVING_MODE();
...
--@usage BOOL _HAS_ASYNC_INSTALL_FINISHED();
...
--@usage BOOL _IS_POP_MULTIPLIER_AREA_UNK(int id);
--@params id int
--@return BOOL
...
--@usage BOOL IS_POSITION_OCCUPIED(float x,float y,float z,float range,BOOL p4,BOOL checkVehicles,BOOL checkPeds,BOOL p7,BOOL p8,Entity ignoreEntity,BOOL p10);
--@params x float
--@params y float
--@params z float
--@params range float
--@params p4 BOOL
--@params checkVehicles BOOL
--@params checkPeds BOOL
--@params p7 BOOL
--@params p8 BOOL
--@params ignoreEntity Entity
--@params p10 BOOL
--@return BOOL
...
--@usage BOOL _IS_PROJECTILE_TYPE_IN_RADIUS(float x,float y,float z,Hash projHash,float radius,BOOL ownedByPlayer);
--@params x float
--@params y float
--@params z float
--@params projHash Hash
...
--@params ownedByPlayer BOOL
--@return BOOL
function IsProjectileTypeInRadius(x, y, z, projHash, radius, ownedByPlayer)
end
...
--@submodule MISC
--@see undefined
--@usage void undefined(int p0,BOOL p1);
--@params p0 int
--@params p1 BOOL
--@return void
...
--@submodule MISC
--@see undefined
--@usage Vector3 undefined(float p0,float p1,float p2,float p3,float p4,float p5,float p6,float p7,float p8,BOOL p9);
--@params p0 float
--@params p1 float
--@params p2 float
--@params p3 float
...
--@submodule MISC
--@see undefined
--@usage void undefined(Any* p0,char* name);
--@params p0 Any*
--@params name char*
--@return void
function N_0x48f069265a0e4bec(p0, name)
end
...
--@params p0 Any
--@return void
function N_0x438822c279b73b93(p0)
end
...
--@usage BOOL _LANDING_MENU_IS_ACTIVE();
...
--@submodule MISC
--@see undefined
--@usage void undefined(Ped ped,char* p1,float p2);
--@params ped Ped
--@params p1 char*
--@params p2 float
--@return void
...
--@submodule MISC
--@see undefined
--@usage float undefined(float p0,float p1,float p2,float p3,float p4,float p5,float p6,float p7,float p8,BOOL p9);
--@params p0 float
--@params p1 float
--@params p2 float
--@params p3 float
...
--@params name char*
--@return void
function N_0x8269816f6cfd40f8(p0, name)
end
...
--@params p2 Any*
--@return BOOL
function N_0x8ef5573a1f801a5c(p0, p1, p2)
end
...
--@submodule MISC
--@see undefined
--@usage BOOL undefined(Vector3* p0,float* p1,BOOL* fadeInAfterLoad,BOOL* p3);
--@params p0 Vector3*
--@params p1 float*
--@params fadeInAfterLoad BOOL*
--@params p3 BOOL*
--@return BOOL
function N_0xa4a0065e39c9f25c(p0, p1, fadeInAfterLoad, p3)
end
...
--@params p0 Any
--@return void
function N_0xa1183bcfee0f93d1(p0)
end
...
--@submodule MISC
--@see undefined
--@usage void undefined(int p0,int p1);
--@params p0 int
--@params p1 int
--@return void
...
--@params name char*
--@return void
function N_0xfaa457ef263e8763(p0, name)
end
...
--@submodule MISC
--@see undefined
--@usage BOOL undefined(float p0,float p1,float p2,float p3,float p4,float p5,float p6,float p7,float p8,float p9,float p10,float p11,float* p12);
--@params p0 float
--@params p1 float
--@params p2 float
--@params p3 float
...
--@params name char*
--@return void
function RegisterBoolToSave(p0, name)
end
...
--@params name char*
--@return void
function RegisterEnumToSave(p0, name)
end
...
--@params name char*
--@return void
function RegisterFloatToSave(p0, name)
end
...
--@params name char*
--@return void
function RegisterIntToSave(p0, name)
end
...
--@params name char*
--@return void
function RegisterInt64ToSave(p0, name)
end
...
--@params p6 Any
--@return Any
function RegisterSaveHouse(p0, p1, p2, p3, p4, p5, p6)
end
...
--@params name char*
--@return void
function RegisterTextLabelToSave(p0, name)
end
...
--@params name char*
--@return void
function RegisterTextLabelToSave_2(p0, name)
end
...
--@module NATIVE
--@submodule MISC
--@see _RESET_LOCALPLAYER_STATE
--@usage void _RESET_LOCALPLAYER_STATE();
...
--@module NATIVE
--@submodule MISC
--@see _SET_CLOUD_HAT_OPACITY
--@usage void _SET_CLOUD_HAT_OPACITY(float opacity);
...
--@module NATIVE
--@submodule MISC
--@see _SET_CUSTOM_RESPAWN_POSITION
--@usage void _SET_CUSTOM_RESPAWN_POSITION(float x,float y,float z,float heading);
--@params x float
--@params y float
--@params z float
--@params heading float
--@return void
function SetCustomRespawnPosition(x, y, z, heading)
end
...
--@usage void SET_INSTANCE_PRIORITY_MODE(BOOL toggle);
--@params toggle BOOL
--@return void
...
--@usage void SET_RANDOM_EVENT_FLAG(Any toggle);
--@params toggle Any
--@return void
...
--@usage void _SET_RAIN_FX_INTENSITY(float intensity);
...
--@usage int SET_SUPER_JUMP_THIS_FRAME(Player player);
--@params player Player
--@return int
...
--@usage BOOL SHOULD_USE_METRIC_MEASUREMENTS();
...
--@module NATIVE
--@submodule MISC
--@see _SHOW_PED_IN_PAUSE_MENU
--@usage void _SHOW_PED_IN_PAUSE_MENU(BOOL toggle);
--@params toggle BOOL
--@return void
function ShowPedInPauseMenu(toggle)
end
...
--@params outW float*
--@return void
function SlerpNearQuaternion(t, x, y, z, w, x1, y1, z1, w1, outX, outY, outZ, outW)
end
...
--@params p0 Any*
--@params size int
--@params arrayName char*
--@return void
function StartSaveArrayWithSize(p0, size, arrayName)
end
...
--@params p0 Any*
--@params size int
--@params structName char*
--@return void
function StartSaveStructWithSize(p0, size, structName)
end
...
--@params p2 BOOL
--@return void
function StartSaveData(p0, p1, p2)
end
...
--@usage BOOL _UI_IS_SINGLEPLAYER_PAUSE_MENU_ACTIVE();
