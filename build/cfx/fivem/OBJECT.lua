...
--@submodule OBJECT
--@see CREATE_OBJECT
--@usage Object CREATE_OBJECT(Object modelHash,float x,float y,float z,BOOL isNetwork,BOOL thisScriptCheck,BOOL dynamic);
...
--@usage Object CREATE_OBJECT_NO_OFFSET(Hash modelHash,float x,float y,float z,BOOL isNetwork,BOOL thisScriptCheck,BOOL dynamic);
--@params modelHash Hash
--@params x float
--@params y float
--@params z float
...
--@submodule OBJECT
--@see _DOOR_CONTROL
--@usage void _DOOR_CONTROL(Hash doorHash,float x,float y,float z,BOOL locked,float xRotMult,float yRotMult,float zRotMult);
--@params doorHash Hash
--@params x float
--@params y float
--@params z float
...
--@usage void DOOR_SYSTEM_SET_AUTOMATIC_DISTANCE(Hash doorHash,float heading,BOOL p2,BOOL p3);
--@params doorHash Hash
...
--@usage void DOOR_SYSTEM_SET_AUTOMATIC_RATE(Hash doorHash,float p1,BOOL p2,BOOL p3);
--@params doorHash Hash
--@params p1 float
--@params p2 BOOL
--@params p3 BOOL
...
--@usage void DOOR_SYSTEM_SET_DOOR_STATE(Hash doorHash,int limit,BOOL p2,BOOL p3);
--@params doorHash Hash
--@params limit int
--@params p2 BOOL
--@params p3 BOOL
...
--@usage void DOOR_SYSTEM_SET_OPEN_RATIO(Hash doorHash,float ajar,BOOL p2,BOOL p3);
--@params doorHash Hash
--@params ajar float
--@params p2 BOOL
--@params p3 BOOL
...
--@usage void DOOR_SYSTEM_SET_SPRING_REMOVED(Hash doorHash,BOOL p1,BOOL p2,BOOL p3);
--@params doorHash Hash
--@params p1 BOOL
--@params p2 BOOL
--@params p3 BOOL
