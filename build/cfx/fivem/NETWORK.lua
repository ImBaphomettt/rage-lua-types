...
--@usage Any NETWORK_ADD_ENTITY_ANGLED_AREA(float p0,float p1,float p2,float p3,float p4,float p5,float p6);
--@params p0 float
--@params p1 float
--@params p2 float
--@params p3 float
...
--@usage BOOL NETWORK_START_RESPAWN_SEARCH_IN_ANGLED_AREA_FOR_PLAYER(Player player,float p1,float p2,float p3,float p4,float p5,float p6,float p7,float p8,float p9,float p10,int flags);
--@params player Player
--@params p1 float
--@params p2 float
--@params p3 float
...
--@usage BOOL NETWORK_START_RESPAWN_SEARCH_FOR_PLAYER(Player player,float p1,float p2,float p3,float p4,float p5,float p6,float p7,int flags);
--@params player Player
--@params p1 float
--@params p2 float
--@params p3 float
