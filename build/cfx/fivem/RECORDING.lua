...
--@module NATIVE
--@submodule RECORDING
--@see _DISABLE_ROCKSTAR_EDITOR_CAMERA_CHANGES
...
--@submodule RECORDING
--@see undefined
--@usage void undefined(char* missionNameLabel,Any p1);
...
--@submodule RECORDING
--@see undefined
--@usage void undefined(float p0,float p1,int p2);
--@params p0 float
--@params p1 float
--@params p2 int
--@return void
...
--@module NATIVE
--@submodule RECORDING
--@see _STOP_RECORDING_AND_SAVE_CLIP
...
--@module NATIVE
--@submodule RECORDING
--@see _STOP_RECORDING_THIS_FRAME
...
--@module NATIVE
--@submodule RECORDING
--@see _STOP_RECORDING_AND_DISCARD_CLIP
