...
--@usage void ATTACH_VEHICLE_ON_TO_TRAILER(Vehicle vehicle,Vehicle trailer,float p2,float p3,float p4,float p5,float p6,float p7,float p8,float p9,float p10,float p11);
--@params vehicle Vehicle
...
--@submodule VEHICLE
--@see CREATE_VEHICLE
--@usage Vehicle CREATE_VEHICLE(Hash modelHash,float x,float y,float z,float heading,BOOL isNetwork,BOOL thisScriptCheck);
...
--@submodule VEHICLE
--@see undefined
--@usage Any undefined(Any p0,Any p1,Any p2,Any p3,Any p4,Any p5,Any p6,Any p7,Any p8);
--@params p0 Any
--@params p1 Any
--@params p2 Any
--@params p3 Any
...
--@submodule VEHICLE
--@see undefined
--@usage void undefined(float x,float y,float z,float p3);
--@params x float
--@params y float
--@params z float
--@params p3 float
...
--@usage void SET_VEHICLE_ENGINE_ON(Vehicle vehicle,BOOL value,BOOL instantly,BOOL noAutoTurnOn);
--@params vehicle Vehicle
--@params value BOOL
