...
--@module NATIVE
--@submodule PLAYER
--@see _GET_ACHIEVEMENT_PROGRESSION
...
--@submodule PLAYER
--@see undefined
--@usage void undefined(Player player1,Player player2,BOOL toggle);
--@params player1 Player
...
--@submodule PLAYER
--@see undefined
--@usage void undefined(Player player,float p1);
--@params player Player
--@params p1 float
--@return void
...
--@submodule PLAYER
--@see undefined
--@usage BOOL undefined(Player player,int p1,BOOL p2);
--@params player Player
--@params p1 int
--@params p2 BOOL
--@return BOOL
...
--@submodule PLAYER
--@see undefined
--@usage BOOL undefined(Player player,float p1);
--@params player Player
--@params p1 float
--@return BOOL
...
--@submodule PLAYER
--@see undefined
--@usage void undefined(Player player,BOOL toggle);
--@params player Player
--@params toggle BOOL
--@return void
...
--@submodule PLAYER
--@see undefined
--@usage BOOL undefined(Player player,int p1);
--@params player Player
--@params p1 int
--@return BOOL
...
--@module NATIVE
--@submodule PLAYER
--@see _SET_ACHIEVEMENT_PROGRESSION
--@usage BOOL _SET_ACHIEVEMENT_PROGRESSION(int achievement,int progress);
--@params achievement int
--@params progress int
--@return BOOL
...
--@usage void SET_PLAYER_BLUETOOTH_STATE(BOOL player,ScrHandle state);
--@params player BOOL
...
--@usage void SET_PLAYER_WANTED_CENTRE_POSITION(Player player,float position,float y,float z);
--@params player Player
...
--@usage void SET_PLAYER_WEAPON_DEFENSE_MODIFIER(Player player,ScrHandle modifier);
--@params player Player
...
--@usage void START_PLAYER_TELEPORT(Player player,float x,float y,float z,float heading,BOOL p5,BOOL findCollisionLand,BOOL p7);
--@params player Player
--@params x float
--@params y float
--@params z float
...
--@module NATIVE
--@submodule PLAYER
--@see _SWITCH_CRIME_TYPE
--@usage void _SWITCH_CRIME_TYPE(Player player,int p1);
--@params player Player
--@params p1 int
--@return void
