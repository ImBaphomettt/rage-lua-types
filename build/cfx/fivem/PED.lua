...
--@submodule PED
--@see CLONE_PED
--@usage Ped CLONE_PED(Ped ped,float heading,BOOL isNetwork,BOOL thisScriptCheck);
--@params ped Ped
--@params heading float
...
--@submodule PED
--@see _CLONE_PED_2
--@usage Ped _CLONE_PED_2(Ped ped,Any heading,Any isNetwork,Any thisScriptCheck,Any p4);
--@params ped Ped
--@params heading Any
...
--@submodule PED
--@see CREATE_PED
--@usage Ped CREATE_PED(int pedType,Hash modelHash,float x,float y,float z,float heading,BOOL isNetwork,BOOL thisScriptCheck);
--@params pedType int
...
--@usage Ped CREATE_PED_INSIDE_VEHICLE(Vehicle vehicle,int pedType,Hash modelHash,int seat,BOOL isNetwork,BOOL thisScriptCheck);
...
--@submodule PED
--@see undefined
--@usage void undefined(Ped ped,char* animDict);
--@params ped Ped
--@params animDict char*
--@return void
