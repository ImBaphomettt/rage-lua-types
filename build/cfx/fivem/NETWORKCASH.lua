...
--@usage BOOL _NETWORK_CAN_SPEND_MONEY_2(Any p0,BOOL p1,BOOL p2,BOOL p3,Any* p4,Any p5);
--@params p0 Any
--@params p1 BOOL
--@params p2 BOOL
--@params p3 BOOL
...
--@usage void NETWORK_EARN_FROM_IMPORT_EXPORT(int amount,Any modelHash);
--@params amount int
...
--@module NATIVE
--@submodule NETWORKCASH
--@see _NETWORK_GET_REMAINING_VC_DAILY_TRANSFERS_2
...
--@usage BOOL _NETWORK_GET_VC_BANK_WALLET_BALANCE_IS_NOT_LESS_THAN(int amount,int characterSlot);
--@params amount int
--@params characterSlot int
--@return BOOL
...
--@usage BOOL _NETWORK_GET_VC_WALLET_BALANCE_IS_NOT_LESS_THAN(int amount,int characterSlot);
--@params amount int
--@params characterSlot int
--@return BOOL
...
--@usage BOOL NETWORK_MONEY_CAN_BET(int amount,BOOL p1,BOOL p2);
--@params amount int
--@params p1 BOOL
--@params p2 BOOL
--@return BOOL
...
--@usage void NETWORK_PAY_MATCH_ENTRY_FEE(int amount,int* matchId,BOOL p2,BOOL p3);
--@params amount int
--@params matchId int*
--@params p2 BOOL
--@params p3 BOOL
...
--@usage void NETWORK_SPENT_BETTING(int amount,int p1,Any* matchId,BOOL p3,BOOL p4);
--@params amount int
--@params p1 int
--@params matchId Any*
--@params p3 BOOL
