...
--@usage BOOL DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Hash componentHash,Hash drawableSlotHash,int componentId);
...
--@submodule FILE
--@see GET_FORCED_PROP
--@usage void GET_FORCED_PROP(Any p0,Any p1,Any* p2,Any* p3,Any* p4);
--@params p0 Any
--@params p1 Any
--@params p2 Any*
--@params p3 Any*
